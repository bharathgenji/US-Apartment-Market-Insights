...
# Boxplot of prices by source
ggplot(data, aes(x = source, y = price)) + 
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(title = "Rental Prices by Source", x = "Source", y = "Price")
...
# Boxplot of prices by source without outliers
ggplot(data_no_outliers, aes(x = source, y = price)) + 
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
